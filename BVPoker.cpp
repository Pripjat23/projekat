...
void findROIs(Mat r, Mat s)
{
	...
	//imwrite("Card_Imgs/Ranks" ".jpg", rr);			//speichert das Template für die Ranks ab
	//imwrite("Card_Imgs/Suits" ".jpg", ss);			//speichert das Template für die Suits ab
...
int main(int argc, char** argv)
{
	...
	src = imread("karta.jpeg");				//Bild wird eingelesen --> zu Video umändern! mit While-Schleife und am Ende break und waitKey(0) von anderem Programm übernehmen
	if (src.empty())
	{
